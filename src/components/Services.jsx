      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Dịch vụ <span className="gradient-text">Marketing</span> của chúng tôi
          </h2>
          <p className="text-lg text-gray-600 dark:text-gray-300">
            Chúng tôi cung cấp các giải pháp marketing toàn diện để giúp doanh nghiệp của bạn
        ...
        >
          {services.map((service, index) => (
            ...
            >
              ...
              <Button
                variant="ghost"
                className="text-blue-600 dark:text-blue-400 p-0 hover:bg-transparent group-hover:translate-x-1 transition-transform"
              >
